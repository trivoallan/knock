...
- Off by default: `HOUBA_RETENTION` unset and no policy `archive:` ⇒ unchanged behaviour. Setting the global var enables retention fleet-wide (policy overrides per field).
