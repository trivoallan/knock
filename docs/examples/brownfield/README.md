...
`docker.io/library/mongo` into the demo registry, stamped with OCI-standard provenance
(`io.houba.owners=group:default/data-platform`), and each receives a syft-generated CycloneDX
