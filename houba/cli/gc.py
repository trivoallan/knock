"""The `houba gc` command — collect superseded scan-result referrers."""
...
from houba.domain.retention import DEFAULT_KEEP, DEFAULT_OLDER_THAN_DAYS
from houba.logging import configure
from houba.use_cases.gc import GcReport, gc_exit_code, gc_referrers
