"""The `knock attach <ref> --report <file|->` command (ingest + stamp a scan result)."""
...
from knock.cli.render import render_scan_outcome
from knock.domain.scan.summary import Severity, gate_breached
from knock.logging import configure
from knock.use_cases.attach import attach_exit_code, attach_scan
