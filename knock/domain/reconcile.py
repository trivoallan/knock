...
from knock.domain.retention import ResolvedRetention, select_retention_excess
...
class MirrorArtifact:
    ...
    attested: bool = True  # does this mirror digest already carry a signed knock attestation?
