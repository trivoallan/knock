...
knock does not run a scanner: the report is produced upstream (CI / registry-native
...
from knock.domain.scan.attestation import build_scan_statement
from knock.domain.scan.constants import SCAN_RESULT_ARTIFACT_TYPE
from knock.domain.scan.detect import resolve_format
from knock.domain.scan.formats.registry import DEFAULT_REGISTRY, Registry
from knock.domain.scan.refs import pin_to_digest
from knock.domain.scan.summary import Severity, build_scan_annotations, gate_breached
from knock.ports.attestor import AttestationRef, AttestorPort
