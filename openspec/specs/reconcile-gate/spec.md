# reconcile-gate Specification

## Purpose

Lets an external evaluator approve or refuse each import, update and rebuild that reconcile would perform, before knock places or signs anything.
