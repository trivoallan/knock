...
then
    ...
    then
        ...
        yes y | keytool -importcert -alias AC_RACINE_SNCF_2023 -keystore $CACERTS_PATH -storepass changeit -file /usr/local/share/ca-certificates/AC_RACINE_SNCF_2023-ppd.crt || true
        ...
        yes y | keytool -importcert -alias AC_INFRASTRUCTURE_SNCF_2023 -keystore $CACERTS_PATH -storepass changeit -file /usr/local/share/ca-certificates/AC_INFRASTRUCTURE_SNCF_2023-ppd.crt || true
    ...
    then
        ...
        yes y | keytool -importcert -alias AC_RACINE_SNCF_2023 -keystore $CACERTS_PATH -storepass changeit -file /etc/pki/ca-trust/source/anchors/AC_RACINE_SNCF_2023-ppd.crt || true
        ...
        yes y | keytool -importcert -alias AC_INFRASTRUCTURE_SNCF_2023 -keystore $CACERTS_PATH -storepass changeit -file /etc/pki/ca-trust/source/anchors/AC_INFRASTRUCTURE_SNCF_2023-ppd.crt || true
